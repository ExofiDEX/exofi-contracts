...
library UniswapV2Library
{
	...
	{
		require(path.length >= 2, "UniswapV2Library: Invalid path");
	...
	{
		require(amountA > 0, "UniswapV2Library: amount <= 0");
		require(reserveA > 0 && reserveB > 0, "UniswapV2Library: Reserve to low");
	...
	{
		require(amountIn > 0, "UniswapV2Library: amountIn <= 0");
		require(reserveIn > 0 && reserveOut > 0, "UniswapV2Library: Reserve to low");
	...
	{
		require(amountOut > 0, "UniswapV2Library: amountOut <= 0");
		require(reserveIn > 0 && reserveOut > 0, "UniswapV2Library: Reserve to low");
